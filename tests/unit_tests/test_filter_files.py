import polars as pl
from container_diffoscope.comparator import _filter_files
...
def test_empty_dataframes():
    ...
    # Act
    result_1 = _filter_files(df1, df2)
    result_2 = _filter_files(df2, df1)
